...
// Config endpoint to return OAuth Client ID and app URL safely
app.get("/api/config", (req, res) => {
  // Google OAuth Client ID provisioned in AI Studio metadata or environment
  // gen-lang-client-0056384592 -> project number 953318826985
  const clientId = process.env.GOOGLE_CLIENT_ID || "953318826985-00000000000000000000000000000000.apps.googleusercontent.com";
  res.json({
...
// Enforces gemini-3.1-pro-preview with thinkingLevel: HIGH as requested by the user
...
// Generates the 3 Scenarios: Ideal, Realista (Crash), Gestión de Crisis/Soluciones
